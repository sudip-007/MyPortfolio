      ...
      <div className="abc">
        <div className="main-box">
         <div className="box-contain">
             ...
             <div className="box-description"><a href=''> It Showcases my skills, experiences and Knowledge</a></div>
        ...
        <div className="main-box">
         <div className="box-contain">
             ...
             <div className="box-description"><a href=''>A Real Time Tracking DashBoard For Crypto</a></div>
         <div className="button">
          <button className="btn primary-btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="main-box">
         <div className="box-contain">
             ...
             <div className="box-description"><a href=''>dhcvud djchnd jdcc dhcvud aa djchnd jdcc </a></div>
         <div className="button">
          <button className="btn primary-btn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
